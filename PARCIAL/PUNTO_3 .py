def listar_jedi_ordenados(jedis):
    jedis_ordenados = sorted(jedis, key=lambda x: (x['name'], x.get('species', '')))
    
    for jedi in jedis_ordenados:
        print(f"Nombre: {jedi['name']}, Especie: {jedi.get('species', 'Desconocida')}")

def mostrar_info_jedi(jedis, nombres):
...
def mostrar_aprendices(jedis, maestros):
    for jedi in jedis:
        if jedi['name'] in maestros:
            print(f"Aprendices de {jedi['name']}:")
            for apprentice in jedis:
                if apprentice['master'] == jedi['name']:
...
def listar_jedi_inicio(jedis, letra):
    for jedi in jedis:
        if jedi['name'].startswith(letra):
            print(jedi['name'])

def mostrar_jedi_varios_colores(jedis):
    for jedi in jedis:
        lightsaber_color = jedi.get('lightsaber_color')
        if lightsaber_color and len(lightsaber_color.split('/')) > 1:
            print(jedi['name'])


def mostrar_jedi_colores_especificos(jedis, colores):
    for jedi in jedis:
        if jedi['lightsaber_color'] in colores:
            print(jedi['name'])

def mostrar_padawans(jedis, maestros):
    for jedi in jedis:
        if jedi['name'] in maestros:
            print(f"Padawans de {jedi['name']}:")
            for apprentice in jedis:
                if apprentice['master'] == jedi['name'] and apprentice['rank'] == 'Padawan':
                    print(apprentice['name'])
            print()

def mostrar_grand_masters(jedis):
    for jedi in jedis:
...
# punto a
print("listado ordenado por nombre y por especie:")
listar_jedi_ordenados(jedis)
print()

# punto b
print("información de Ahsoka Tano y Kit Fisto:")
mostrar_info_jedi(jedis, ['Ahsoka Tano', 'Kit Fisto'])
print()

# punto c
print("todos los padawan de yoda y luke skywalker:")
mostrar_aprendices(jedis, ['Yoda', 'Luke Skywalker'])
print()

# punto d
print("Jedi de especie humana y twi lek:")
mostrar_jedi_especie(jedis, ['Human', 'Twi\'lek'])
print()

#punto e
print("jedis que empiezan con a:")
listar_jedi_inicio(jedis, 'A')
print()

# punto f
print("Jedi que usaron sable de luz de varios colores:")
mostrar_jedi_varios_colores(jedis)
print()

# punto g
print("jedi que utilizaron sable de luz amarillo o violeta:")
mostrar_jedi_colores_especificos(jedis, ['Yellow', 'Violet'])
print()

#punto h
print("nombres de los padawans de Qui Gon Jin y Mace windu, si los tuvieron:")
mostrar_padawans(jedis, ['Qui-Gon Jinn', 'Mace Windu'])
print()

#punto i
print("Jedi que tienen el ranking de Grand Master:")
mostrar_grand_masters(jedis)
